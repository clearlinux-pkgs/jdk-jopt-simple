...
%package data
Summary: data components for the jdk-jopt-simple package.
Group: Data

%description data
data components for the jdk-jopt-simple package.


%prep
%setup -q -n jopt-simple-jopt-simple-4.6

python3 /usr/share/java-utils/pom_editor.py pom_xpath_remove "pom:build/pom:extensions"
python3 /usr/share/java-utils/pom_editor.py pom_remove_dep org.infinitest:continuous-testing-toolkit
python3 /usr/share/java-utils/pom_editor.py pom_remove_plugin org.pitest:pitest-maven
python3 /usr/share/java-utils/pom_editor.py pom_remove_plugin org.codehaus.mojo:cobertura-maven-plugin
python3 /usr/share/java-utils/pom_editor.py pom_remove_plugin org.apache.maven.plugins:maven-pmd-plugin

%build
python3 /usr/share/java-utils/mvn_build.py -f

%install
xmvn-install  -R .xmvn-reactor -n jopt-simple -d %{buildroot}
